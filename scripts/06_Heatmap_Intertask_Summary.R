...
if (interactive() ){ 
  ...
  if (whichModel == '1'){sim <- read_xlsx(file.path(data_path,"intertask_constrained_sum.xlsx"))[,-1]} # choose: intertask_(un)constrained_sum.csv}
  else if (whichModel == '2'){sim <- read_xlsx(file.path(data_path,"intertask_unconstrained_sum.xlsx"))[,-1]}
